...
kdn251/interviews: Everything you need to know to get the job. (github.com)
...
50+ Data Structure and Algorithms Interview Questions for Programmers | Hacker Noon
万字总结：如何全方位的准备数据结构和算法？ (qq.com)

准备程序员面试？你需要了解这 14 种编程面试模式

Grokking the Coding Interview: Patterns for Coding Questions - Learn Interactively (educative.io)
...
程序员面试通关的 101 道真题 (qq.com)

101 Coding Problems and few Tips to Crack Your Next Programming Interviews - DEV Community
坚持刷题678天的感受！ (qq.com)

程序员必须掌握哪些算法？算法与数据结构文章详细分类与整理！ (qq.com)

从一个面试题看程序员的几项基本功 (qq.com)

LeetCode 中有哪些题的解法让你拍案叫绝？ (qq.com)

算法工程师技术路线图 (qq.com)

算法工程师技术路线图 - 知乎 (zhihu.com)
...
Backtracking
干货满满！全面详解如何用递归解题！ (qq.com)

一文学会「回溯搜索算法」解题技巧 (qq.com)

初识广度优先搜索与解题套路 (qq.com)

一文看懂全排列算法！ (qq.com)

递归回溯中的一些套路 (qq.com)

告别递归，从零开始一文学会递归解题 (qq.com)

超详细！详解一道高频算法题：括号生成 (qq.com)
...
Divide and conquer
面试必考的「二分算法」系统梳理 (qq.com)

搞定面试算法系列 | 分治算法三步走 (qq.com)
...
LeetCode 图解 | 540. 有序数组中的单一元素 (qq.com)
Dynamic Programming
